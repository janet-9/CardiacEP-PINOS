...
if args.phys_loss: 
    results_folder_name = (f"{args.results}_{dataset_type}_PINO_"
                           f"{args.adapt}_{args.phys_method}_{args.res_loss}_resloss_{args.ic_loss}_icloss_{args.bc_loss}_bcloss_{args.w_loss}_wloss_{args.eval_metric}_eval_{args.D}_D_{args.frames}_frames_{timestamp}")
else: 
